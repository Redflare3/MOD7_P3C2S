...
{
    internal class FilmFavorit_103022400141
    {
        [JsonInclude]
        ...
        {
            string filePath = @"D:\\Modul7_P3C2S\\Modul7_P3C2S\\Jurnal7_1_103022400141.json";
            string jsonData = File.ReadAllText(filePath);
            FilmFavorit_103022400141 fm = JsonSerializer.Deserialize<FilmFavorit_103022400141>(jsonData);
